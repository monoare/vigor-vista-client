...
const ActivityLog = () => {
  ...
  return (
    <div>
      ...
      <div className="container ml-5 mx-auto mt-8">
        <div className="rotate-2 shadow-lg rounded-md">
          <div className="bg-white p-8 shadow-lg -rotate-2 rounded-md">
            ...
            <div className="mt-8">
              ...
              <p>
                Name:{" "}
                <span className="text-blue-500">{activityData?.userName}</span>
              </p>
              <p>
                Email:{" "}
                <span className="text-blue-500">{activityData?.userEmail}</span>
              </p>
            </div>
          </div>
        </div>
